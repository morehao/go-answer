...
import (
	"go-answer/internal/apps/answer/dto/dtouser"
	"go-answer/internal/apps/answer/service/svcuser"
...
// @Router /answer/user/create [post]
...
// @Router /answer/user/delete [post]
...
// @Router /answer/user/update [post]
...
// @Router /answer/user/pageList [get]
